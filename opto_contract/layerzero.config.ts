...
const sepoliaContract: OmniPointHardhat = {
    ...
    contractName: 'MyOApp',
    address: '0xC081e3CC49D5e4ac78486D2A40140a5cB81328de',
}

const hederaContract: OmniPointHardhat = {
    eid: EndpointId.HEDERA_V2_TESTNET,
    contractName: 'MyOApp',
    address: '0xF6EB0F927f801c93569EB71257D4231F4C03257E',
}
...
export default async function () {
    ...
    return {
        contracts: [{ contract: sepoliaContract }, { contract: hederaContract }],
        connections,
    }
}
